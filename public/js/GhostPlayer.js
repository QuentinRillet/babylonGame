/**
 * Created by rilletq on 15/02/17.
 */
...
GhostPlayer = function (game, ghostData, idRoom) {
  ...
  let positionSpawn = new BABYLON.Vector3(ghostData.position.x, ghostData.position.y, ghostData.position.z)

  let rotationSpawn = new BABYLON.Vector3(ghostData.rotation.x, ghostData.rotation.y, ghostData.rotation.z)
